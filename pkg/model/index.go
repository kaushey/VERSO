...
// EntryId returns the raw 20-byte object id stored for this index entry.
...
func (index *Index) Save() error {
	...
	file, _ := os.OpenFile(path.Join(utils.VersoPath, "index"), os.O_RDWR|os.O_CREATE|os.O_TRUNC, 0644)
	defer file.Close()
